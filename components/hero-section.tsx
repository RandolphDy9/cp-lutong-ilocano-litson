      ...
      <div className="relative z-10 text-center text-white px-4 mx-auto">
        <div className="animate-fade-in-up bg-black/75 backdrop-blur-sm rounded-2xl p-6 sm:p-8 md:p-10 lg:p-12 shadow-lg inline-block mx-auto">
          ...
          <Button
            ...
            size="lg"
            className="bg-orange-600 hover:bg-orange-700 text-white font-sans text-base sm:text-lg px-6 sm:px-8 py-2.5 sm:py-3 rounded-full transition-all duration-300 transform hover:scale-105 shadow-lg w-full sm:w-auto justify-center"
          >
